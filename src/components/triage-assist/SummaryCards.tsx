    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 justify-start gap-4 pt-4">
        <Card className="bg-red-100 dark:bg-red-900/40 border-red-200 dark:border-red-800 w-32 h-32">
         ...
         <Card className="bg-amber-100 dark:bg-amber-900/40 border-amber-200 dark:border-amber-800 w-32 h-32">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
         ...
         <Card className="bg-green-100 dark:bg-green-900/40 border-green-200 dark:border-green-800 w-32 h-32">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
